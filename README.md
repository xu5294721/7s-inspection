...
当前版本：[v1.1.1](https://github.com/xu5294721/7s-inspection/releases/tag/v1.1.1)。支持网页/PWA 和 Android APK 两种使用方式。
...
从 [v1.1.1 Release](https://github.com/xu5294721/7s-inspection/releases/tag/v1.1.1) 下载 APK，传至 Android 手机后，在“下载”目录中点击安装。如系统提示，请仅对所使用的文件管理器授权“允许安装未知应用”。
