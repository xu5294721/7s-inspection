...
export function SettingsPage() {
  return <section className="page-section settings-page">
    ...
    <Link aria-label="检查内容模板" className="settings-link" to="/settings/check-templates"><FileText aria-hidden="true" size={22} /><span><strong>检查内容模板</strong><small>配置大项、小项及默认选项</small></span></Link>
